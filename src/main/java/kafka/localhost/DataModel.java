...
public class DataModel extends kafka.product.DataModel implements Serializable {

    public Hieu hieuanloz = new Hieu();
    public byte[] bytes;
    ...
    public Hieu getHieuanloz() {
        return hieuanloz;
    }

    public void setHieuanloz(Hieu hieuanloz) {
        this.hieuanloz = hieuanloz;
    }
